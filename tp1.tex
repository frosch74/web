...
%À la fin de la séance, vous devrez être en mesure de structurer une pagedocument 
%HTML simple et de le mettre en forme sans aide extérieure.
% 'effectuer des requêtes sur
%votre base de données sans aide extérieure. Ceci implique que le SGBD doit être
%correctement paramétré, la base de données créée et accessible, et les données
%présentes.

%\textbf{Durée~:~} 2 séances Le TP peut aussi bien être réalisé sur un système 
%Gnu/Linux que Ms-Windows.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section{Préalable}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Les données relatives aux différentes séances seront disponibles au fur et à
%mesure sur la plateforme Moodle\footnote{\texttt{http://foad.ensicaen.fr}}. 
%Veuillez vous assurer que vous êtes bien inscrit au module \emph{Conception
%de sites Web} (catégorie Formation Classique / Spécialité Informatique
%/ 1ère année). La clé d'inscription est \og{}\texttt{web}\fg{}.
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.85\textwidth]{image-cv1-css.png} 
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=1.0\textwidth]{image-cv2-css.png} 
