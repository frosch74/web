...
%                                   MINI PROJET
%                  ENSICAEN, SPECIALITE INFORMATIQUE, 1ERE ANNEE
%------------------------------------------------------------------------------
%  Auteurs : Alain Lebret  (2014/15)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\fancyhf{}
\lhead{}
\rhead{\includegraphics[height=\headheight]{../images/logoEcole.jpg}}
\lfoot{\textit{Spécialité informatique - Conception de sites Web}\\\includegraphics[height=0.12\headheight]{../images/vague2013seule.jpg}
A. Lebret (2015)}
\rfoot{\thepage}
...
\begin{center}
  ...
  \textbf{\large{Mini-projet : \og{}Un site Web personnel\fg{}}}\par\smallskip
%  1\iere ~partie : \emph{Mise en page et contenu}
\end{center}\bigskip
...
%        La liste des rubriques accessibles pouvant être considérée comme une
%        liste non ordonnée et sans puces. 
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{images/site_accueil.pdf} 
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{images/site_cv.pdf} 
...
Cette rubrique %est constituée au moins d'un titre de niveau 1 (le nom de la 
%rubrique) et d'un sous-titre (le sujet du blog) ainsi que d'un ensemble d'articles.
%Elle 
dispose d'un fonction de mise en valeur du texte des articles (encadrement des
articles, mise en valeur du texte à emphase, couleurs, etc.) par l'intermédiaire
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{images/site_blog.pdf} 
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{images/site_blog_enjoliver.pdf}
    \includegraphics[width=0.48\textwidth]{images/site_blog_rechercher.pdf} 
...
%\begin{figure}[h]
%  \begin{center}
%    \includegraphics[width=0.7\textwidth]{images/site_blog_rechercher.pdf} 
%    \caption{Résultat d'une recherche de mot dans la rubrique \og{}Blog\fg{}}
%    \label{fig:mep5} 
%  \end{center}
%\end{figure}
...
\begin{figure}[htbp]
  \begin{tabular}{cc}
    \includegraphics[width=0.49\textwidth]{images/exemple_portfolio_0.pdf} & \includegraphics[width=0.49\textwidth]{images/exemple_portfolio_1.pdf} \\\hline 
    ...
    \includegraphics[width=0.49\textwidth]{images/exemple_portfolio_2.pdf} & \includegraphics[width=0.49\textwidth]{images/exemple_portfolio_4.pdf} \\\hline 
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{images/site_portfolio1.pdf}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{images/site_portfolio2.pdf} 
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{images/site_contact.pdf} 
...
\vspace{3pt}
\begin{itemize}
   \item facile \includegraphics[width=0.12\textwidth]{images/etoile1.pdf}
   \item plutôt facile \includegraphics[width=0.12\textwidth]{images/etoile2.pdf}
   \item difficulté moyenne \includegraphics[width=0.12\textwidth]{images/etoile3.pdf}
   \item plutôt difficile \includegraphics[width=0.12\textwidth]{images/etoile4.pdf}
   \item difficile \includegraphics[width=0.12\textwidth]{images/etoile5.pdf}
\end{itemize}
\vspace{3pt}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
(Niveau de difficulté \includegraphics[width=0.12\textwidth]{images/etoile1.pdf})
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
(Niveau de difficulté \includegraphics[width=0.12\textwidth]{images/etoile2.pdf})
...
<html lang="fr">
  ...
  <body>
    <header>
      <h1>Jean Saigne</h1><h2>Développeur en herbe</h2>
      <nav></nav>
    </header>
    <main>
      <!-- Le reste du contenu -->
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%S'il est possible de donner à un site un aspect \og{}dynamique\fg{} en utilisant
%les feuilles de styles, comme par exemple à l'aide du sélecteur \Code{:hover} 
%qui permet de modifier l'aspect du lien d'une rubrique dans le menu de 
%navigation lors de son survol par la souris, la mise au point d'un site 
%véritablement réactif, vis-à-vis du visiteur, requiert l'utilisation d'un 
%langage adapté tel que Javascript. 
%Ainsi, la rubrique \Code{Blog} dispose de trois fonctionnalités qui nécessitent
%l'utilisation de code Javascript, de même que les rubriques \Code{Contact} si 
%vous souhaitez y intégrer une carte Google, et encore bien d'autres si vous 
%êtes très ambitieux. 
...
\Code{enjoliver} (\includegraphics[width=0.10\textwidth]{images/etoile2.pdf})
...
\begin{itemize}
  \item \Code{rechercherMot} : rechercher et surligner un mot dans les articles 
        (\includegraphics[width=0.10\textwidth]{images/etoile3.pdf}) ;
  \item \Code{creerNuageMots} : générer un nuage des mots les plus fréquents 
        (\includegraphics[width=0.10\textwidth]{images/etoile4.pdf}) ;
...
%function init(){
%   /* Appel des fonctions qui doivent être chargée au démarrage,
%      par exemple l'affichage du nuage de mots */
%}
%
%/* Définitions de vos fonctions */
%
%/* 
%* Quand toutes les données sont chargées (DOM, images, sons, vidéos,
%* etc.), on fait de même avec la fonction init()
%*/
%window.onload = init;
%\end{verbatim}           
%}
...
%(Niveau de difficulté \includegraphics[width=0.12\textwidth]{images/etoile3.pdf})
\paragraph*{Obligatoire}~\\
...
(\includegraphics[width=0.12\textwidth]{images/etoile3.pdf}). L'envoi du mail à 
l'administrateur sera remplacé par l'écriture dans un fichier texte des 
informations fournies par le visiteur. 

\paragraph*{Optionnel}~\\
Ajouter la gestion de l'image captcha (\includegraphics[width=0.12\textwidth]{images/etoile3.pdf})
et insérez une carte Google pour permettre votre localisation   
(\includegraphics[width=0.12\textwidth]{images/etoile2.pdf}).
...
(\includegraphics[width=0.12\textwidth]{images/etoile2.pdf}). Le nombre de
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Ressources sur Internet}
%\subsubsection{Choisir vos polices}
%\begin{itemize}
%  \item http://www.typetester.org/
%\end{itemize} 
%
%\subsubsection{Choisir vos couleurs}
%\begin{itemize}
%  \item http://www.code-couleur.com/ : site généraliste sur la couleur
%  \item http://www.colourlovers.com/ : site généraliste avec de nombreux 
%        choix de palettes
%  \item http://www.degraeve.com/color-palette/ : générateur de palettes 6 
%        couleurs à partir de photos
%  \item http://www.color-hex.com/ : générateur de couleurs très simple
%\end{itemize}
%
%\subsubsection{Bibliothèques Javascript}
%\begin{itemize}
%  \item Généralistes : JQuery\footnote{La bibliothèque JQuery fournit un 
%        ensemble de fonctions qui permettent d'analyser la structure d'un 
%        fichier HTML, voire de la modifier, de manipuler les CSS pour les 
%        adapter. Elle propose aussi des fonctions d'affichage ou d'animation
%        adaptées à la présentation de galeries d'images, de portfolios, etc.
%        En complément de l'API de jQuery disponible à la source, vous pouvez 
%        consulter les tutoriels du W3C sur le sujet.} (http://jquery.com) 
%  \item Coloration syntaxique : Prism (http://prismjs.com/)
%  \item Nuages de mots-clés : Wordcloud.js (http://timdream.org/wordcloud2.js),
%        Tagcanvas (http://www.goat1000.com/tagcanvas.php), 
%        D3-cloud (https://github.com/jasondavies/d3-cloud)
%\end{itemize}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Internet Explorer et HTML5}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Les versions d'Internet Explorer inférieures à la version 9 ne reconnaissent
%pas les nouvelles balises sémantiques HTML5. Il est nécessaire d'insérer dans
%l'en-tête de vos pages le code suivant qui permettra aux navigateurs 
%d'analyser correctement vos pages.
% 
%\footnotesize{ 
%\begin{verbatim}
%<!--[if lt IE 9]-->
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%En plus du cours de Luc Brun disponible sur Moodle, voici deux sites sur 
%lesquels vous pouvez allègrement butiner afin d'obtenir plus d'informations 
%sur le langage Javascript : 
%
%\begin{itemize}
%  \item Les tutoriels du W3C : http://www.w3schools.com/js/
%  \item De nombreux exemples : http://www.javascriptkit.com/  
%\end{itemize}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{CGI}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%En plus du cours de Luc Brun disponible sur Moodle, voici un site avec de
%nombreux exemples CGI : 
%
%\begin{itemize}
%  \item http://www.resourceindex.com/
%\end{itemize}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Favicon}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Le favicon est la petite icône qui permet de symboliser un site Web et qui
%apparaît dans la barre d'adresse, la barre de titre ou encore sur les onglets
%et autres raccourcis du navigateur. Cette icône est en général de taille 
%$16\times16$ ou $32\times32$ pixels et utilise le format \texttt{ico} 
%(Ms-Windows) ou \texttt{png}. 
%Par exemple, afin d'associer l'icône \Code{favicon.png} à une page Web, il 
%est nécessaire d'ajouter dans l'en-tête de la page la ligne suivante :
%\begin{verbatim}
